...
CHESTS[(568, 648)] = {'name': "Grandpa's chest", 'map': '15', 'locked': False, 'combo': None, 'difficulty': 0, 'inventory': {'lantern': 1, 'shotgun': 1, 'copper ingot': 100, 'leather strips': 10, 'flint': 2, 'iron ore': 16, 'iron ingot': 32, 'empty bottle': 5, 'leather': 16, 'abandoned chest key': 1, 'lock pick': 2}}
