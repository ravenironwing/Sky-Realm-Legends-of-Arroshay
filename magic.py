...
MAGIC['fireball'] = {'name': 'fireball', 'type': 'magic', 'fireballs': 1, 'damage': 30, 'cost': 20, 'sound': 'fire blast', 'brightness': 250, 'light mask': 1}
MAGIC['fire spray'] = {'name': 'fire spray', 'type': 'magic', 'fireballs': 10, 'damage': 50, 'cost': 75, 'sound': 'fire blast', 'brightness': 280, 'light mask': 2}
