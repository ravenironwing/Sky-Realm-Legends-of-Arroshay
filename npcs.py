...
PEOPLE['generic'] = {'name': 'generic', 'protected': True, 'health': 100, 'touch damage': False, 'damage': 0, 'knockback': 2, 'walk speed': DEFAULT_WALK_SPEED, 'run speed': DEFAULT_RUN_SPEED, 'detect radius': DEFAULT_DETECT_RADIUS, 'avoid radius': DEFAULT_AVIOD_RADIUS, 'aggression': 'awp', 'armed': True, 'dual wield': False,
    'collide': ['walls', 'lava'],
...
PEOPLE['villager'] = {'name': 'Villager', 'protected': True, 'health': 100, 'touch damage': False, 'damage': 5, 'knockback': 2, 'walk speed': DEFAULT_WALK_SPEED, 'run speed': DEFAULT_RUN_SPEED, 'detect radius': DEFAULT_DETECT_RADIUS, 'avoid radius': DEFAULT_AVIOD_RADIUS, 'aggression': 'fwp', 'armed': False, 'dual wield': False,
    'collide': ['walls', 'lava'],
    'gender': 'random', 'race': 'osidine',
